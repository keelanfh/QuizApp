...
public class MultiplayerAllQuestionScreen extends AppCompatActivity {
    ...
    public void goToQuestion(int q){
        ...
        if (App.isOdd(q-1)) {
            App.currentUser.setUsername(App.player2Name);
            App.nextUser.setUsername(App.player1Name);
        }
        else {
            App.currentUser.setUsername(App.player1Name);
            App.nextUser.setUsername(App.player2Name);
        }
